                                            ...
                                            <div class="row-fluid" style="margin-bottom: 5px">
                                                    <div class="span6">
                                                        <div style="width: 90%; float: left">
                                                            halaman 2 dari 2<span style="color: #de0300"><b></b></span>
                                                        </div>
                                    ...
                                    <form id="registerForm" name="registrationform" action="https://my.telkomsel.com/SelfPSB/register" method="post" enctype="multipart/form-data">
                                        ...
                                        <div style="padding: 0 7.5%; font-family: &#39;Titillium Web&#39;, sans-serif; font-size: 15px; font-weight: 400; color: #666; margin-bottom: 5%">
                                            ...
                                            <div class="row-fluid" style="margin-bottom: 5px">
                                                ...
                                                <div class="span6">
                                                    <input id="firstName" name="firstName" class="inputCustome" placeholder="Isi dengan nama lengkap" type="text" value="" maxlength="100">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid" style="margin-bottom: 5px;" id="alamatPengantaran">
                                                <div class="row-fluid" style="margin-bottom: 5px">
                                                    ...
                                                    <div class="span6">
                                                        <input id="alamat2" name="deliveryaddress" class="inputCustome" placeholder="Isi dengan alamat sesuai KTP" type="text" value="" maxlength="127">
										...
										<div id="halo2" style="padding: 0 7.5%; font-family: &#39;Titillium Web&#39;, sans-serif; font-size: 15px; font-weight: 400; color: #666; margin-bottom: 5%">
                                            ...
                                            <div class="row-fluid" style="margin-bottom: 5px">
                                                ...
                                                <div class="span6">
                                                    <input id="firstName" name="firstName" class="inputCustome" placeholder="Isi dengan nama ibu kandung" type="text" value="" maxlength="100">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid" style="margin-bottom: 1px;">
											 ...
											 <div class="row-fluid" style="margin-bottom: 5px">
                                                ...
                                                <div class="span6">
                                                    <input id="firstName" name="firstName" class="inputCustome" placeholder="Isi apabila memiliki alamat email pemberi referensi" type="text" value="" maxlength="100">
                                                </div>
                                            </div>

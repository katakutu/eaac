...
?>
								...
								<div style="padding: 5% 2.5%;border:red 1px;">
									...
									<form id="registerForm" name="registrationform" action="<?php echo base_url(). 'registrasi/submit'; ?>" method="post" enctype="multipart/form-data">
										...
										<fieldset id="halaman2">
											...
											<!--END INPUT DATA DIRI --><!--END JUDUL DATA DIRI -->
	...
	<a href="https://my.telkomsel.com/SelfPSB"><img src="<?php echo base_url() ?>asset/Customer Service Online_files/pack_kartuhalo.jpg"></a>
			  <div style="font-family:&#39;Titillium Web&#39;,sans-serif;font-size:15px;color:#333">
				<img src="<?php echo base_url() ?>asset/Customer Service Online_files/icon-arrow.png" style="margin-right:15px"><a href="https://my.telkomsel.com/SelfPSB/download/Terms.pdf" style="color:#333">Syarat &amp; Ketentuan</a>
				<hr style="margin:10px 0">
				<img src="<?php echo base_url() ?>asset/Customer Service Online_files/icon-arrow.png" style="margin-right:15px"><a href="https://my.telkomsel.com/SelfPSB/orderStatus" style="color:#333">Status Pemesanan kartuHalo</a>
				<hr style="margin:10px 0"> 
				<img src="<?php echo base_url() ?>asset/Customer Service Online_files/icon-arrow.png" style="margin-right:15px"><a href="https://my.telkomsel.com/SelfPSB/CekStatusPembayaran" style="color:#333">Status Pembayaran Pemesanan kartuHalo</a>
			  </div> -->
